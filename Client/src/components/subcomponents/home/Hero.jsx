...
export default function Hero() {
    ...
    return (
        <section id='hero' className=' mt-8 lg:mt-20  lg:pl-6 xl:px-0 flex sm:items-center sm:justify-center '>
            <div className="container flex lg:justify-center lg:flex-row xl:mr-auto xl:ml-0 lg:gap-6 xl:p-14 xl:py-24 2xl:gap-24  lg:py-12 lg:items-start flex-col-reverse items-center gap-16 pt-10 overflow-x-hidden xl:px-20 2xl:px-0">
                <div className='flex flex-col gap-8 lg:gap-6 justify-center  lg:ml-6 lg:pl-24 xl:pl-0'>
                    ...
                    <div className="div flex justify-center item mt-4">
                        ...
                        <button className='btn btn-primary flex-shrink-0 w-40 h-4 rounded-full tracking-wider bg-neutral-950 border-none text-timberwolf uppercase hover:bg-neutral-950' onClick={() => navigate("/login")}>get started</button>
                    </div>
                </div>
